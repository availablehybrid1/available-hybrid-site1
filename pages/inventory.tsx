...
export default function VehicleDetail({ car }: DetailProps) {
    ...
    return (
      <main className="min-h-screen bg-neutral-950 text-neutral-100">
        <div className="mx-auto max-w-4xl px-4 py-10">
          ...
          <Link
            href="/inventory"
            className="mt-4 inline-flex text-sm text-emerald-400 underline-offset-2 hover:underline"
          >
            ← Back to inventory
          </Link>
        </div>
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <header className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 border-b border-neutral-900">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="relative h-12 w-12 sm:h-14 sm:w-14 rounded-full bg-neutral-900/80 ring-1 ring-white/20 overflow-hidden">
            <Image
          ...
          <div className="leading-tight">
            ...
            <h1 className="text-sm sm:text-base font-semibold group-hover:text-neutral-50">
              R&amp;M Inc.
            </h1>
        ...
        <div className="flex flex-col items-end gap-1 text-right text-xs">
          ...
          <a
            ...
            className="inline-flex items-center rounded-full border border-white/30 px-4 py-1.5 text-[11px] font-medium text-white hover:bg-white hover:text-neutral-900 transition"
          >
            CALL +1 747-354-4098
          </a>
        </div>
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-6 px-4 pb-12 pt-4 lg:flex-row">
        ...
        <section className="flex-1">
          ...
          <div className="overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/70">
            <div className="relative w-full bg-neutral-800 h-[230px] sm:h-[360px] flex items-center justify-center">
              {mainPhoto ? (
                <button
                  type="button"
        ...
        {/* INFO DEL VEHÍCULO */}
        <section className="flex-1 rounded-xl border border-neutral-800 bg-neutral-900/70 p-4 text-xs sm:p-5">
          ...
          <div className="mt-4 rounded border border-neutral-800 bg-neutral-900/80 p-3 text-[11px]">
            ...
            {!vinLoading && !vinError && !vinInfo && (
              <p className="text-neutral-500">
                No additional VIN data available.
              </p>
            )}
          </div>
                    ...
                    <div className="space-y-2 rounded border border-neutral-800 bg-neutral-950/80 p-3">
                      ...
                      <div className="mt-3 rounded bg-neutral-900 p-3 text-[11px]">
                        ...
                        <p className="mt-1 text-[10px] text-neutral-500">
                          This calculator is for illustration only and does not
                          constitute a credit offer. All amounts are estimates
                          and **do not include applicable sales tax, DMV
                          registration/transfer fees, or optional products and
                          services**. Final terms are subject to full credit
                          review and signed contract.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          {showOffer && (
            ...
            >
              ...
              <button
                type="submit"
                className="mt-2 rounded bg-emerald-500 px-3 py-1 text-[11px] font-medium text-neutral-900 hover:bg-emerald-400"
              >
                Send Offer
              </button>
            </form>
